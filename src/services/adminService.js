...
export const getAllUsers = async (token) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/user-management/admin/get-all-users`,
      {
        credentials: "include",
        headers: {
...
export const resetAllBoxes = async (token) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/box-selection/set-all-boxes-to-unselected`,
      {
        method: "PUT",
        credentials: "include",
        headers: {
...
export const setBoxColor = async (token, color) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/box-selection/admin/set-box-color`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
export const getBoxColor = async (token) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/box-selection/box-color`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const getLoginText = async (token) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/box-selection/login-text`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const updateLoginText = async (token, settings) => {
  try {
    const response = await fetch(
      `https://hrp-backend-kaki-kaki-hrp.vercel.app/api/box-selection/admin/login-text`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
